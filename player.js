...
function initializePlayer(client) {
    ...
    client.riffy.on("trackStart", async (player, track) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`➡️ **Название этой невъебической песни:** [${track.info.title}](${track.info.uri})\n➡️ **Автор:** ${track.info.author}\n➡️ **Платформы :** YouTube, Spotify, SoundCloud`)
            ...
            .setTimestamp()
            .setFooter({ text: 'Кликай на кнопки ниже для управления' });
        ...
        collector.on('collect', async i => {
            ...
            if (i.customId === 'loopQueue') {
                ...
                const loopEmbed = new EmbedBuilder()
                    ...
                    .setColor("#00FF00")
                    .setTitle("**Активирован цикл очереди**")
                ...
                const skipEmbed = new EmbedBuilder()
                    ...
                    .setTitle("**Ща начнёт играть новая невъебическая песенка, готовьтесь Лоуренсы**")
                    .setTimestamp();
                ...
                const loopEmbed = new EmbedBuilder()
                    ...
                    .setDescription('**Цикл отключен для очереди и отдельной песни!**');
                    ...
                    const queueEmbed = new EmbedBuilder()
                        .setColor("#0099ff")
                        .setAuthor({
                            name: 'Очередь очищена',
                            iconURL: 'https://cdn.discordapp.com/attachments/1230824451990622299/1230836684774576168/7762-verified-blue.gif?ex=6638b97d&is=663767fd&hm=021725868cbbc66f35d2b980585489f93e9fd366aa57640732dc49e7da9a80ee&',
                            url: ''
                        })
                        .setDescription('**Пошла нахуй эта очередь, слушайте только мои треки, я чсв**');
        ...
        client.riffy.on("queueEnd", async (player) => {
            ...
            if (autoplay) {
                ...
                const queueEmbed = new EmbedBuilder()
                    .setColor("#0099ff")
                    .setDescription('**Треки в очереди закончились и поэтому бот пошёл по съёбам**');
